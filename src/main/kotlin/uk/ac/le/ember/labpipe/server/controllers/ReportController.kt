...
class ReportController {
    companion object {
        fun generateHtml(operator: Operator, form: FormTemplate, formData: JsonObject): String? {
            ...
            reportTemplate?.run {
                logger.info { "Report template found." }
                logger.info { reportTemplate.html.size }
                ...
                elements.forEach { element ->
                    run {
                        logger.info { "Processing report element: $element" }
